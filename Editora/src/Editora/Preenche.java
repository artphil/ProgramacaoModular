...
public class Preenche {
	...
	// Classe que inicializa o sistema para geração de testes
	
	// Metodo que inicializa a lista de Publicações
	...
	public static void cliente(Lista listaCliente) {
		...
		cliente.setNome("João Paulo Fagundes");
		cliente.setCPF("015.658.412-66");
		cliente.setEndereco("Rua Maranhão, 42");
		...
		cliente.setEndereco("Rua São Gonsalo, 266");
	...
	public static void assinat(Lista listaAssinat, Lista listaCliente, Lista listaPublic) {
		...
		cliente = (Cliente) listaCliente.Busca("João Paulo Fagundes");
