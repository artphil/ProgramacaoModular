...
public class TestePoligons { 
	...
	public static void main(String[] args) {
		...
		// Não é possivel acessar ou modificar o campo diretamente,
		// pois o mesmo está com o modificador "private"
		// c3.radius = 2.5;
		//System.out.println( "O circulo tem raio de " + c3.radius);
				
		// Declara t1 como variável pelo construtor padrão Triangle ()
		Triangle t1 = new Triangle();
		
		// Imprime os atributos da classe Triangle invoacando o metodo toString()
		System.out.println(t1.toString());
		
		// Declara t2 como variável pelo segundo construtor Triangle (args...)
